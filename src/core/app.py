...
from src.features.backpack import BackpackPage
from src.features.chat import ChatPage
from src.features.growth import GrowthPage
from src.features.interaction import InteractionPage
from src.features.notification import NotificationPage
from src.features.settings import SettingsPage
from src.services.llm_client import LLMClient, build_pet_system_prompt
from src.data.store import ITEM_CATALOG, PetDataStore
from src.pet.window import PolarBearPetWindow
...
class PolarBearPetApp(QMainWindow):
    ...
    def _build_sidebar(self):
        ...
        mascot = PremiumSidebarMascotCard(Path(__file__).resolve().parents[2] / "assets" / "polar_bear")
    ...
    def _build_overview_page(self):
        ...
        pet_stage = PremiumMascotStage(Path(__file__).resolve().parents[2] / "assets" / "polar_bear")
    ...
    def _build_tray(self):
        if not QSystemTrayIcon.isSystemTrayAvailable():
            return
        icon_path = Path(__file__).resolve().parents[2] / "assets" / "polar_bear" / "polar-bear-realistic.png"
